...
public class Login {
	...
	public void user_open_browser_and_enter_url() throws Throwable {
		...
		if (driver.getPageSource().contains("Sign up / Log in to get the best of Cleartrip")) {
			...
			driver.findElement(
					By.xpath("//header/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]/button[1]/div[1]"))
					.click();
	...
	// driver.findElement(By.xpath("//button[contains(text(),'Log in / Sign
	// up')]")).click();
	// }
	//
	// @Then("^user click on continue with login$")
	// public void user_click_on_continue_with_login() throws Throwable {
	// driver.findElement(By.xpath("//span[contains(text(),'Continue with
	// Email')]")).click();
	// }
	...
	public void user_enter_password_as(String pwd) throws Throwable {
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[4]/div[2]/div[1]/div[2]/div[3]/div[1]/input[1]"))
				.sendKeys(pwd);
	}
