...
public class HotelsPOM {
	...
	public HotelsPOM(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "(//input[contains(@class,'bn box-border')])[1]")
	WebElement MinPrice;
	@FindBy(xpath = "(//input[contains(@class,'bn box-border')])[2]")
	WebElement MaxPrice;

	//Hotel class options
	@FindBy(xpath = "(//div[contains(@class,'flex flex-between')])[2]/following-sibling::div/label/div/div")
	List<WebElement> hotelclassOptions;
	@FindBy(xpath = "(//span[contains(@class,'checkbox__mark bs-border')])[1]")
	WebElement Hoteloption1;
	@FindBy(xpath = "(//span[contains(@class,'checkbox__mark bs-border')])[2]")
	WebElement Hoteloption2;
	@FindBy(xpath = "(//span[contains(@class,'checkbox__mark bs-border')])[3]")
	WebElement Hoteloption3;
	@FindBy(xpath = "(//span[contains(@class,'checkbox__mark bs-border')])[4]")
	WebElement Hoteloption4;
	...
	@FindBy(xpath = "//input[@value='hotelWithDeals']/following-sibling::span[1]")
	WebElement SpecialOption1;
	@FindBy(xpath = "//input[@value='freeCancellation']/following-sibling::span[1]")
	WebElement SpecialOption2;

	// Trip Advisor rating options
	...
	WebElement TripOption1;
	@FindBy(xpath = "(//span[contains(@class,'radio__circle bs-border')])[2]")
	WebElement TripOption2;
	@FindBy(xpath = "(//span[contains(@class,'radio__circle bs-border')])[3]")
	WebElement TripOption3;
	@FindBy(xpath = "(//span[contains(@class,'radio__circle bs-border')])[4]")
	WebElement TripOption4;
	...
	@FindBy(xpath = "(//span[@class='checkbox__mark bs-border bc-neutral-500 bw-1 ba'])[7]")
	WebElement AmenitiesOption1;
	@FindBy(xpath = "(//span[@class='checkbox__mark bs-border bc-neutral-500 bw-1 ba'])[8]")
	WebElement AmenitiesOption2;
	@FindBy(xpath = "(//span[@class='checkbox__mark bs-border bc-neutral-500 bw-1 ba'])[9]")
	WebElement AmenitiesOption3;
	...
	@FindBy(xpath = "//input[@value='HOT']/following-sibling::span[1]")
	WebElement PropertyOption1;
	@FindBy(xpath = "(//span[@class='checkbox__mark bs-border bc-neutral-500 bw-1 ba'])[22]")
	WebElement PropertyOption2;
	@FindBy(xpath = "(//span[@class='checkbox__mark bs-border bc-neutral-500 bw-1 ba'])[23]")
	WebElement PropertyOption3;
	...
	@FindBy(xpath = "(//p[@class='fs-2'])[1]")
	WebElement PriorityOption1;
	@FindBy(xpath = "(//p[@class='fs-2'])[2]")
	WebElement PriorityOption2;
	@FindBy(xpath = "(//p[@class='fs-2'])[3]")
	WebElement PriorityOption3;
	@FindBy(xpath = "(//p[@class='fs-2'])[4]")
	WebElement PriorityOption4;
	@FindBy(xpath = "(//p[@class='fs-2'])[5]")
	WebElement PriorityOption5;

	//View details btn
	@FindBy(xpath = "(//button[text()='View details'])[1]")
	WebElement select;

	//Select room and options page
	...
	public void ContDetails() throws Throwable {
		...
		number.clear();
		number.sendKeys("9876556789");
		Thread.sleep(2000);

		mail.clear();
		mail.sendKeys("kesannrk459@gmail.com");
		Thread.sleep(2000);
